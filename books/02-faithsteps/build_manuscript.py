...
# manuscript 작성
L=[];ap=L.append
shutil.os.makedirs(os.path.join(ROOT,'books/02-faithsteps/images'),exist_ok=True)
shutil.copyfile(os.path.join(ROOT,'books/17-amos/images/logo.png'), os.path.join(ROOT,'books/02-faithsteps/images/logo.png'))
...
bdir=os.path.join(ROOT,'books/02-faithsteps')
