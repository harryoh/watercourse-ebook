...
- **성경/주제**: 사무엘하
- **장 수**: 본문 25개 (전체 섹션 28개: 머리말·판권·교회안내 포함)
...
python3 shared/lib/extract_hwp.py books/18-samuel-2   # (기존 manuscript.md 보존; --force로 덮어쓰기)
# 2) 표지(필요 시)
python3 shared/lib/make_cover.py books/18-samuel-2
# 3) 검토
python3 shared/lib/review.py books/18-samuel-2
# 4) EPUB 빌드
./build.sh books/18-samuel-2
```
